 ...
 *
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "simpleArrayStringRule".
 */
...
export type LowerUpperRule = (
  ...
  | [
      (("lower" | "upper" | unknown) | CoreRule) &
        (((("lower" | "upper" | unknown) | CoreRule) & string) | (("lower" | "upper" | unknown) | CoreRule)),
      (("lower" | "upper" | unknown) | CoreRule) &
        (((("lower" | "upper" | unknown) | CoreRule) & string) | (("lower" | "upper" | unknown) | CoreRule))
    ]
) &
...
export type BooleanRule = (
  ...
  | (true | [])
  | [
      ((true | unknown) | CoreRule) & ((((true | unknown) | CoreRule) & boolean) | ((true | unknown) | CoreRule)),
      ((true | unknown) | CoreRule) & ((((true | unknown) | CoreRule) & boolean) | ((true | unknown) | CoreRule))
    ]
) &
  (
...
export type NewlineSpaceWithIgnoreRule = (
  ...
  | [
      (
        | ("always" | "always-single-line" | "never-single-line" | "always-multi-line" | "never-multi-line" | unknown)
        | CoreRule
      ) &
        (
          | ((
...
export type SpaceRule = (
  ...
  | [
      (("always" | "never" | "always-single-line" | "never-single-line" | unknown) | CoreRule) &
        (
          | ((("always" | "never" | "always-single-line" | "never-single-line" | unknown) | CoreRule) & string)
          | (("always" | "never" | "always-single-line" | "never-single-line" | unknown) | CoreRule)
        ),
      (("always" | "never" | "always-single-line" | "never-single-line" | unknown) | CoreRule) &
        (
...
export type SingleDoubleRule = (
  ...
  | [
      (("single" | "double" | unknown) | CoreRule) &
        (((("single" | "double" | unknown) | CoreRule) & string) | (("single" | "double" | unknown) | CoreRule)),
      (("single" | "double" | unknown) | CoreRule) &
        (((("single" | "double" | unknown) | CoreRule) & string) | (("single" | "double" | unknown) | CoreRule))
    ]
) &
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "simpleStringOrArrayStringRule".
 */
...
/**
 * This interface was referenced by `AVAConfigSchema`'s JSON-Schema
 * via the `definition` "array-of-strings".
 */
 ...
 * via the `definition` "possibleErrors".
 */
...
/**
 * This interface was referenced by `JSONSchemaForESLintConfigurationFiles`'s JSON-Schema
 * via the `definition` "bestPractices".
 */
...
/**
 * This interface was referenced by `JSONSchemaForESLintConfigurationFiles`'s JSON-Schema
 * via the `definition` "nodeAndCommonJs".
 */
...
/**
 * This interface was referenced by `JSONSchemaForESLintConfigurationFiles`'s JSON-Schema
 * via the `definition` "stylisticIssues".
 */
...
/**
 * This interface was referenced by `JSONSchemaForESLintConfigurationFiles`'s JSON-Schema
 * via the `definition` "ecmaScript6".
 */
  ...
  "color-hex-length"?: (
    ...
    | [
        (("short" | "long" | unknown) | CoreRule) &
          (((("short" | "long" | unknown) | CoreRule) & string) | (("short" | "long" | unknown) | CoreRule)),
        (("short" | "long" | unknown) | CoreRule) &
          (((("short" | "long" | unknown) | CoreRule) & string) | (("short" | "long" | unknown) | CoreRule))
      ]
  ) &
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "customMedia".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "customProperty".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "declaration".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "declarationBlock".
 */
  ...
  "declaration-block-properties-order"?: (
    ...
    | [
        (("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) &
          (
            | ((("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) & string)
            | ((("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) & unknown[])
            | (("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule)
          ),
        ...((("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) &
          (
...
export interface Font {
  ...
  "font-family-name-quotes"?: (
    ...
    | [
        (("always-where-required" | "always-where-recommended" | "always-unless-keyword" | unknown) | CoreRule) &
          (
            | ((("always-where-required" | "always-where-recommended" | "always-unless-keyword" | unknown) | CoreRule) &
                string)
            | (("always-where-required" | "always-where-recommended" | "always-unless-keyword" | unknown) | CoreRule)
    ...
    (
      | (null &
          (
            ...
            | [
                (
                  | ("always-where-required" | "always-where-recommended" | "always-unless-keyword" | unknown)
                  | CoreRule
                ) &
                  (
                    | ((
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "generalSheet".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "keyframeDeclaration".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "mediaQueryList".
 */
  ...
  "rule-nested-empty-line-before"?: (
    ...
    | [
        (("always" | "never" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) &
          (
            | ((("always" | "never" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) & string)
            | (("always" | "never" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule)
          ),
        (("always" | "never" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) &
          (
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "selectorList".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "shorthandProperty".
 */
...
/**
 * This interface was referenced by `JSONSchemaForTheStylelintConfigurationFiles`'s JSON-Schema
 * via the `definition` "stylelintDisableComment".
 */
 ...
 * via the `definition` "branch-object".
 */
